...
import { any, z, ZodAnyDef, ZodParsedType, ZodSchema, ZodType, ZodTypeAny } from "zod"
...
export function CardWithForm() {
  ...
  //     item.questoes_da_etapa.forEach(({ questao: { alias_do_campo, tipo_da_questao } }) => {
  //       let atp
  //       if ((tipo_da_questao === 'Número')) {
  //         atp = z.number()
  //       } else {
  //         atp = z.string()
  //       }
  //       let dn = `${alias_do_campo}: ${atp}`
  //       let questaoAtual = {
  //         name: alias_do_campo,
  //         fieldType: atp,
  //       };
  //       questionFields.push(questaoAtual);
          ...
          <CardContent>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <Button type='submit' className="h-[56px] w-full bg-highlight text-base font-bold text-black">
                  Ok
